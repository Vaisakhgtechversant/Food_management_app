...
const location=useNavigate()
  ...
  const handleUpdate = async (e) => {
    ...
    const result = await axios.post(`http://localhost:8000/api/updateData/${params.id}`,body)
  ...
  return (
    <div className="flex justify-center mt-5">
      <form className='w-full max-w-md bg-white shadow-lg rounded-xl p-6 border' action="">
        ...
        {/* <Link to={'/'}> */}
          <button className='bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition' onClick={(e) => handleUpdate(e)}>Update</button>
        {/* </Link> */}
